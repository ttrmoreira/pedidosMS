package br.com.moreirafood.pedidos.controller;

import br.com.moreirafood.pedidos.dto.PedidoDto;
import br.com.moreirafood.pedidos.dto.StatusDto;
import br.com.moreirafood.pedidos.service.PedidoService;
...
public class PedidoController {
        ...
        public String retornaPorta(@Value("${local.server.port}") String porta){
            return String.format("Requisição respondida pela instância execuntando na porta %s",porta);
        }
